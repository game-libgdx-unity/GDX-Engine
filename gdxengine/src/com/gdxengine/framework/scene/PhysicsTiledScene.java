...
public abstract class PhysicsTiledScene extends TiledScene {
	 ...
	 * @param gameService
	 */
	public PhysicsTiledScene(IGameService gameService) {
		super(gameService);
	...
	/**
	 * Create a physics scene with tmx map and texture folder of tmx map
	 * 
	 * @param gameService
	 * @param mapfile
	 * @param textureDir
	 */
	public PhysicsTiledScene(IGameService gameService, String mapfile,
			String textureDir) {
	...
	public void update(float gameTime) {
		...
		//update bodies in world physics
		...
		while (bi.hasNext()) {
			...
			if (b.getUserData() instanceof IPhysicsObject) {
			...
			} else if (b.getUserData() instanceof Image) {
				...
				e.setPosition(x, y);
				e.setRotation(1 * MathUtils.radiansToDegrees * b.getAngle());
			}
	 ...
	 * @return
	 */
	protected FixtureDef addFixtureDef(TiledObject object, Vector2 center,
